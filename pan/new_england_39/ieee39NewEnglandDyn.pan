...
parameters D=0 OVERLOAD=0

options outintnodes=yes ; pivcaching=0

Dc0 dc nettype=yes print=no sparse=1

Init control begin

    Flag = 0;

%     Gold = get("Pg31.pg")*100M;
% 
%     if( abs( get("Pg31.pe") - Gold ) < 100u*Gold )
%         printf( "+----------------+\n" );
% 	printf( "| PF TEST PASSED |\n" );
%         printf( "+----------------+\n" );
%     else
%         printf( "+------------------------+\n" );
% 	printf( "| PF TEST **NOT** PASSED |\n" );
%         printf( "+------------------------+\n" );
% 	abort();
%     end
...
Tr tran stop=2000 nettype=yes method=2 order=2 sparse=2 begin

    if( Flag == 0 && get("Tr.time",-1) > 500 ) 
        Flag = 1;
	Al alter instance="Lo3" param="pc" value=(1+OVERLOAD)*3.22-0.1 invalidate=0
    end
end
...
T30   pm30  omega30 powertg type=1 omegaref=1 r=0.02 pmax=10 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg30"

Pg30 bus30 avr30 pm30 omega30 powergenerator pg=(1+OVERLOAD)*2.5 \
    vg=1.047500e+00 \
...
T31   pm31  omega31 powertg type=1 omegaref=1 r=0.02 pmax=10 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg31"

Pg31 bus31 avr31 pm31 omega31 powergenerator pg=(1+OVERLOAD)*5.729300e+00 \
    vg=1.040000e+00 \
    prating=1.000000e+08 vrating=1.000000e+03 qmax=8.000000e+00 \
    qmin=-5.000000e+00 pmax=9.999900e+01 pmin=0.000000e+00 \
...
T32   pm32  omega32 powertg type=1 omegaref=1 r=0.02 pmax=10 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg32"

Pg32 bus32 avr32 pm32 omega32 powergenerator pg=(1+OVERLOAD)*6.500000e+00 \
    vg=9.831000e-01 \
    prating=1.000000e+08 vrating=1.000000e+03 qmax=8.000000e+00 \
    qmin=-5.000000e+00 pmax=9.999900e+01 pmin=0.000000e+00 \
...
Pg33 bus33 powergenerator pg=(1+OVERLOAD)*6.320000e+00 vg=9.972000e-01 \
    prating=1.000000e+08 vrating=1.000000e+03 qmax=8.000000e+00 \
    qmin=-5.000000e+00 pmax=9.999900e+01 pmin=0.000000e+00 \
    type=4 ra=0 xdp=0.0436 xqp=0.1660 xd=0.2620 xq=0.258 \
    td0p=5.69 tq0p=1.50 xl=0.0295 h=28.6 d=D qlimits=no

Pg34 bus34 powergenerator pg=(1+OVERLOAD)*5.080000e+00 vg=1.012300e+00 \
...
T35   pm35  omega35 powertg type=1 omegaref=1 r=0.02 pmax=10 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg35"

Pg35 bus35 avr35 pm35 omega35 powergenerator pg=(1+OVERLOAD)*6.500000e+00 \
...
Pg36 bus36 powergenerator pg=(1+OVERLOAD)*5.600000e+00 vg=1.063500e+00 \
    prating=1.000000e+08 vrating=1.000000e+03 qmax=8.000000e+00 \
    qmin=-5.000000e+00 pmax=9.999900e+01 pmin=0.000000e+00 \
    type=4 ra=0 xdp=0.0490 xqp=0.1860 xd=0.2950 xq=0.292 \
    td0p=5.66 tq0p=1.50 xl=0.0322 h=26.4 d=D qlimits=no

Pg37 bus37 powergenerator pg=(1+OVERLOAD)*5.400000e+00 vg=1.027800e+00 \
    prating=1.000000e+08 vrating=1.000000e+03 qmax=8.000000e+00 \
    qmin=-5.000000e+00 pmax=9.999900e+01 pmin=0.000000e+00 \
...
T38   pm38  omega38 powertg type=1 omegaref=1 r=0.02 pmax=10 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg38"

Pg38 bus38 avr38 pm38 omega38 powergenerator pg=(1+OVERLOAD)*8.300000e+00 \
...
T39   tg39  omega39 powertg type=1 omegaref=1 r=0.02 pmax=12 pmin=0 ts=0.1 \
                            tc=0.45 t3=0 t4=12 t5=50 gen="Pg39" 
...
Pg39 bus39 avr39 pm39 omega39 x39 y39 powergenerator pg=(1+OVERLOAD)*1.005729e+01 vg=1.030000e+00 \
...
; | Power loads |
; +-------------+
Lo3  bus3  powerload pc=(1+OVERLOAD)*3.220000e+00 qc=(1+OVERLOAD)*2.400000e-02 vrating=1.000000e+03 prating=1.000000e+08
Lo4  bus4  powerload pc=(1+OVERLOAD)*5.000000e+00 qc=(1+OVERLOAD)*1.840000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo7  bus7  powerload pc=(1+OVERLOAD)*2.338000e+00 qc=(1+OVERLOAD)*8.400000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo8  bus8  powerload pc=(1+OVERLOAD)*5.220000e+00 qc=(1+OVERLOAD)*1.760000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo12 bus12 powerload pc=(1+OVERLOAD)*8.500000e-02 qc=(1+OVERLOAD)*8.800000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo15 bus15 powerload pc=(1+OVERLOAD)*3.200000e+00 qc=(1+OVERLOAD)*1.530000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo16 bus16 powerload pc=(1+OVERLOAD)*3.294000e+00 qc=(1+OVERLOAD)*3.230000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo18 bus18 powerload pc=(1+OVERLOAD)*1.580000e+00 qc=(1+OVERLOAD)*3.000000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo20 bus20 powerload pc=(1+OVERLOAD)*6.800000e+00 qc=(1+OVERLOAD)*1.030000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo21 bus21 powerload pc=(1+OVERLOAD)*2.740000e+00 qc=(1+OVERLOAD)*1.150000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo23 bus23 powerload pc=(1+OVERLOAD)*2.475000e+00 qc=(1+OVERLOAD)*8.460000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo24 bus24 powerload pc=(1+OVERLOAD)*3.086000e+00 qc=(1+OVERLOAD)*-9.220000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo25 bus25 powerload pc=(1+OVERLOAD)*2.240000e+00 qc=(1+OVERLOAD)*4.720000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo26 bus26 powerload pc=(1+OVERLOAD)*1.390000e+00 qc=(1+OVERLOAD)*1.700000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo27 bus27 powerload pc=(1+OVERLOAD)*2.810000e+00 qc=(1+OVERLOAD)*7.550000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo28 bus28 powerload pc=(1+OVERLOAD)*2.060000e+00 qc=(1+OVERLOAD)*2.760000e-01 vrating=1.000000e+03 prating=1.000000e+08
Lo29 bus29 powerload pc=(1+OVERLOAD)*2.835000e+00 qc=(1+OVERLOAD)*1.269000e+00 vrating=1.000000e+03 prating=1.000000e+08
Lo31 bus31 powerload pc=(1+OVERLOAD)*9.200000e-02 qc=(1+OVERLOAD)*4.600000e-02 vrating=1.000000e+03 prating=1.000000e+08
Lo39 bus39 powerload pc=(1+OVERLOAD)*1.104000e+01 qc=(1+OVERLOAD)*2.500000e+00 vrating=1.000000e+03 prating=1.000000e+08

; +-------------+
; | Power lines |
; +-------------+
Line1 bus1 bus39 powerline r=1.000000e-03 x=2.500000e-02 b=7.500000e-01 prating=1.000000e+08 vrating=1.000000e+03
...
Line4 bus3 bus4 powerline r=1.300000e-03 x=2.130000e-02 b=2.214000e-01 prating=1.000000e+08 vrating=1.000000e+03
...
Line18 bus14 bus15 powerline r=1.800000e-03 x=2.170000e-02 b=3.660000e-01 prating=1.000000e+08 vrating=1.000000e+03
Line19 bus15 bus16 powerline r=9.000000e-04 x=9.400000e-03 b=1.710000e-01 prating=1.000000e+08 vrating=1.000000e+03
Line20 bus16 bus17 powerline r=7.000000e-04 x=8.900000e-03 b=1.342000e-01 prating=1.000000e+08 vrating=1.000000e+03
