...
Av2a      g2a   ex2a poweravr vmax=5 vmin=-5 ka=20 ta=0.055 te=0.36 kf=0.125 \
                              tf=1.8 tr=0.05 vrating=20k type=2 ae=0.0056 be=1.075

Tg2a pm02a omega02a     powertg type=1 omegaref=1 r=0.02 pmax=1 pmin=0.0 \
...
Av2b      g2b   ex2b poweravr vmax=5 vmin=-5 ka=20 ta=0.055 te=0.36 kf=0.125 \
                              tf=1.8 tr=0.05 vrating=20k type=2 ae=0.0056 be=1.075

Tg2b pm02b omega02b     powertg type=1 omegaref=1 r=0.02 pmax=1 pmin=0.0 \
		  	        ts=0.1 tc=0.45 t3=0 t4=12 t5=50 dza=DZA
