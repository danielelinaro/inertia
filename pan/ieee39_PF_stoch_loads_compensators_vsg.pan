...
VSG03      dx   qx  dc10  gnd  omegacoi VSG VG=16.5k*0.9831 P_REF=800M PG=0.8125 \
                     CF=0.0002 LF=0.00008 RF=0.00003 TA=2*4.47 KD=0.1 KW=0.1

Rdc  dc10  dc20  resistor r=10m
Edc  dc20   gnd  vsource  vdc=10k
...
model VSG nport veriloga="vsg.va"
